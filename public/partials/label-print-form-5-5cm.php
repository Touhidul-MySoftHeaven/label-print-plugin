          ...
          <div class="col-md-12">
            <div class="table_container">
              <div class="page_heading_container">
                <h1 class="page_heading">Skapa hyllkantsetiketter - Höjd 5,1cm</h1>
              </div>
                  ...
                  <table class="table table-condensed table-hover">
                    <thead>
                      <tr class="well">
                        ...
                        <th>Antal</th>
                        <th>Pris kr/st</th>
                        <th>Fritext (ersätter all text)</th>
                        <th></th>
                      </tr>
                    </thead>
                      ...
                      <tr id="row_id_<?php echo get_the_ID();?>" class="product-single-row" r-id="<?php echo get_the_ID();?>">
                        ...
                        <td>
                          <input
                            ...
                            class="form-control"
                            name="custom_text[]"
                            id="custom_text-<?php echo get_the_ID();?>"
